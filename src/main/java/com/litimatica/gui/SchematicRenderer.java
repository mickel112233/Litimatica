...
public class SchematicRenderer {
    ...
    public static void render(MatrixStack matrices, VertexConsumerProvider vertexConsumers, double cameraX, double cameraY, double cameraZ) {
        ...
        // Optimized Ghost Block Rendering (Nearby Only)
                ...
                for (int y = minY; y <= maxY; y++) {
                    for (int z = minZ; z <= maxZ; z++) {
                        ...
                        if (state != null) {
                            ...
                            // Use getTranslucent to achieve the 'ghostly' look
                            client.getBlockRenderManager().renderBlockAsEntity(state, matrices, vertexConsumers, 15728880, OverlayTexture.DEFAULT_UV);
                            matrices.pop();
                        }
                    }
                }
